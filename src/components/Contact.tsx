...
export default function Contact() {
  ...
  return (
    <section className="relative bg-black min-h-[580px] overflow-hidden flex flex-col justify-between py-20 px-16 md:px-24" id="contact">
      {/* Background Video */}
      <video
        ref={videoRef}
        autoPlay
      ...
      <div className="relative z-[4] w-full max-w-[1200px] mx-auto flex flex-col items-center">
        ...
        <h2 className="font-sans text-5xl md:text-6xl lg:text-7xl font-bold text-[#E1E0CC] tracking-[-0.03em] flex items-baseline whitespace-nowrap justify-center">
      ...
      <div className="relative z-[4] flex-1 flex flex-col items-center justify-center mt-16">
          ...
          {contacts.map((contact, i) => (
            <div key={contact.label} className="flex items-center">
              ...
              <motion.a
                ...
                className="group flex flex-col items-center px-16"
                target={contact.href.startsWith('http') ? '_blank' : undefined}
                rel="noreferrer"
              >
                <span className="font-sans text-[11px] font-normal tracking-[0.2em] text-[#E1E0CC]/35 group-hover:text-[#E1E0CC]/60 uppercase mb-2 transition-colors duration-200">
                  {contact.label}
                </span>
                <span className="flex items-center gap-2 font-sans text-xl font-medium text-[#E1E0CC] transition-colors duration-200">
                  {contact.value}
